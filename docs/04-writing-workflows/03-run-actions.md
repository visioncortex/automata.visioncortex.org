...
Computes an expression and stores the result. Supports arithmetic, string concatenation, comparisons, and a range of built-in functions. See [Expressions](/docs/core-concepts/expressions) for the full syntax.
